...
# inpath <- paste("/Users/pveltsos/Desktop/voom/", sep="")
# outpath <- paste("/Users/pveltsos/Desktop/voom/", sep="")
...
# GenoData = read.cross(format = "csvs", dir="/Users/pveltsos/Desktop/voom/", genfile = paste(line, "genotypes.txt", sep="."), phefile = paste(line, "count.txt", sep="."), estimate.map = T)
