...
# inpath <- paste("/Users/pveltsos/Documents/Uni Projects/Mimulus/mim_voom/new/", sep="")
...
GenoData = read.cross(format = "csvs", dir="/panfs/pfs.local/scratch/kelly/p860v026/qtl/in", genfile = paste(line, "rQTL.genotype.txt", sep="."), phefile = paste(line, "count.txt", sep="."), estimate.map = F)
# GenoData = read.cross(format = "csvs", dir="/Users/pveltsos/Documents/Uni Projects/Mimulus/mim_voom/new", genfile = paste(line, "rQTL.genotype.txt", sep="."), phefile = paste(line, "count.txt", sep="."), estimate.map = F)
...
save.image(file=paste(outpath, line, '_short.Rdata', sep=""))
