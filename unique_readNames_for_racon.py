...
# Racon needs unique names for paired end reads before the gap, this scripts adds 1 or 2 to make the read names unique https://github.com/isovic/racon/issues/68
